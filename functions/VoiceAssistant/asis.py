...
def respond(voice_data):
    ...
    # 4: time
    if there_exists(["what's the time","tell me the time","what time is it","what is the time", "show time", "show me the time"], voice_data):
    ...
    if there_exists(["search"], voice_data) and 'youtube' not in voice_data:
    ...
    # if there_exists(["where am i", "where i am", "my location"], voice_data):
    ...
    #     print(local_ip)
    #     city = get('http://ip-api.com/json/',local_ip).json()
    #     loc = city['city']
   ...
   # Current location as per Google maps
    if there_exists(["what is my exact location", "exact location", "where am i", "where i am", "my location"], voice_data):
